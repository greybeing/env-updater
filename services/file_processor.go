...
// Extracts the part of the filename after the last dot for matching
...
// calculateMatchScore returns a score based on how many characters match between two strings, non-sequentially
